...
In general, the lab will provide up to ***$1,500 per person per year*** for full-time lab members to present their work at major conferences (e.g., ASMS, Keystone, HuPO), inclusive of hotel, flights, meals, and related travel costs. This budget expectation is effective immediately and applies to current and future travel planning. Conference travel support is contingent on submitting an abstract for a poster or oral presentation. In general, the work should be "new" and it should be appropriate for the conference. This will usually result in one conference per year. If travel expenses are being paid off of a grant, additional restrictions may apply (come speak with me if you are unsure).
